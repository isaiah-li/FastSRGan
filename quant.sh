...
python quant_gan.py --model_name 'fastsr_model_leaky' --image_dir '/mnt/SuperResolution/data/test_Internet' --output_dir 'result/fastsr_model_leaky_quant-4k' --train_dir '/mnt/SuperResolution/data/DIV2K_train_HR' --hr_size 384 --lr 1e-4 --save_iter 200 --epochs 3 --batch_size 8
